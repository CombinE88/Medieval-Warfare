...
{
	public class HorizontalSupportPowerTooltipLogic : ChromeLogic
	{
		[ObjectCreator.UseCtor]
		public HorizontalSupportPowerTooltipLogic(Widget widget, TooltipContainerWidget tooltipContainer, HorizontalSupportPowersWidget palette, World world)
		{
