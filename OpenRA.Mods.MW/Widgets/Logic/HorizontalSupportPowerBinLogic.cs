...
{
	public class HorizontalSupportPowerBinLogic : ChromeLogic
	{
		[ObjectCreator.UseCtor]
		public HorizontalSupportPowerBinLogic(Widget widget, World world)
		{
			var palette = widget.Get<HorizontalSupportPowersWidget>("VERTICAL_SUPPORT_PALETTE");
