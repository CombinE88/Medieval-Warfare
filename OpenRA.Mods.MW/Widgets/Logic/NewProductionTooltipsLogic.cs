...
{
	public class NewProductionTooltipLogic : ChromeLogic
	{
		[ObjectCreator.UseCtor]
		public NewProductionTooltipLogic(Widget widget, TooltipContainerWidget tooltipContainer, Player player, Func<ProductionIcon> getTooltipIcon)
		{
			...
			tooltipContainer.BeforeRender = () =>
			{
				...
				var cost = actor.HasTraitInfo<UndeadBuilderInfo>() ? actor.TraitInfo<UndeadBuilderInfo>().Cost + actor.TraitInfo<ValuedInfo>().Cost
					: actor.TraitInfo<ValuedInfo>().Cost;
