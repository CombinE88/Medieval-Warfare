...
namespace OpenRA.Mods.MW.MWAI
{
	...
	public sealed class HackyMWAIInfo : IBotInfo, ITraitInfo
	{
		...
		public class UndeadCategories
		{
			...
			public readonly HashSet<string> Sppool = new HashSet<string>();
	...
	public sealed class HackyMWAI : ITick, IBot, INotifyDamage
	{
		...
		public void Activate(Player p)
		{
			...
			foreach (var defense in Info.DefenseQueues)
				builders.Add(new BaseBuilder(this, defense, p, playerResource));
		...
		public bool HasAdequateFact()
		{
			...
			return CountBuildingByCommonName(Info.BuildingCommonNames.ConstructionYard, Player) > 0 ||
				CountBuildingByCommonName(Info.BuildingCommonNames.Stable, Player) == 0;
		}
		...
		void ProtectOwn(Actor attacker)
		{
			...
			if (!protectSq.IsValid)
			{
				var ownUnits = World.FindActorsInCircle(World.Map.CenterOfCell(GetRandomBaseCenter()), WDist.FromCells(Info.ProtectUnitScanRadius))
					...
					!Info.UnitsCommonNames.ExcludeFromDefenders.Contains(unit.Info.Name));
