...
namespace OpenRA.Mods.MW.Projectiles
{
	...
	public class LaserInfo : IProjectileInfo
	{
		...
		public virtual IProjectile Create(ProjectileArgs args) { return new Laser(args, this); }
	}

	public class Laser : IProjectile
	{
		protected readonly LaserInfo info;
		protected readonly Color[] colors;
		protected readonly WPos[] offsets;

		protected readonly WVec leftVector;
		protected readonly WVec upVector;
		protected readonly MersenneTwister random;
		...
		public Laser(ProjectileArgs args, LaserInfo info)
		{
			...
			else
			{
				...
				CalculateOffsets(args, numSegments, direction);
		...
		protected virtual void CalculateOffsets(ProjectileArgs args, int numSegments, WVec direction)
		{
