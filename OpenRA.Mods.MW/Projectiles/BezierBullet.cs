...
{
	public class BezierBulletInfo : IProjectileInfo
	{
		...
		public IProjectile Create(ProjectileArgs args) { return new BezierBullet(this, args); }
	}

	public class BezierBullet : IProjectile, ISync
	{
		readonly BezierBulletInfo info;
		...
		public BezierBullet(BezierBulletInfo info, ProjectileArgs args)
		{
			this.info = info;
			this.args = args;
			pos = args.Source;
