...
namespace OpenRA.Mods.MW.Traits
{
    ...
    class CombinEGrantRandomConditionInfo : ConditionalTraitInfo
    {
        [FieldLoader.Require]
        ...
        public override object Create(ActorInitializer init) { return new CombinEGrantRandomCondition(this); }
    }

    class CombinEGrantRandomCondition : ConditionalTrait<CombinEGrantRandomConditionInfo>
    {
        ConditionManager conditionManager;
        int conditionToken = ConditionManager.InvalidConditionToken;
        private string pickedCondition;

        public CombinEGrantRandomCondition(CombinEGrantRandomConditionInfo info)
            : base(info) { }
