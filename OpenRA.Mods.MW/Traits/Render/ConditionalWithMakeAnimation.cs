...
namespace OpenRA.Mods.MW.Traits.Render
{
	...
	public abstract class ConditionalWithMakeAnimationInfo : ConditionalTraitInfo, Requires<WithSpriteBodyInfo>
	{
		...
		public override object Create(ActorInitializer init) { return new ConditionalWithMakeAnimation(init, this); }
	}

	public class ConditionalWithMakeAnimation : ConditionalTrait<ConditionalWithMakeAnimationInfo>, INotifyCreated, INotifyDeployTriggered
	{
		readonly ConditionalWithMakeAnimationInfo info;
		...
		public ConditionalWithMakeAnimation(ActorInitializer init, ConditionalWithMakeAnimationInfo info) : base(info)
		{
			this.info = info;
			var self = init.Self;
		...
		void INotifyCreated.Created(Actor self)
		{
			...
			if (!skipMakeAnimation && !IsTraitDisabled)
				Forward(self, () => { });
		}
